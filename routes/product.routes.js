...
const { productsGet, productsGetById, productsPost, productsPut, productsDelete, productsPaginadoPost } = require('../controllers/product.controllers');
...
router.post('/paginado', [
    jsonParser,
    validateFields], productsPaginadoPost);
